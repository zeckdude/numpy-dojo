...
export const scenarios: Scenario[] = [
  {
    ...
    context: 'You\'re a teacher with exam scores for 5 students across 4 tests. You need to analyze performance, identify struggling students, and curve the grades.',
    lessonsUsed: [0, 1, 5, 8],
    steps: [
      {
